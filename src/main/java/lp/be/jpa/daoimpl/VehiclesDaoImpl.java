...
import lp.be.jpa.dao.VehiclesDao;
import lp.be.jpa.entity.VehiclesEntity;
...
public class VehiclesDaoImpl extends EntityManager implements VehiclesDao {
    ...
    public Vehicles mapEntityToDto(VehiclesEntity entity) {
        if (entity == null) {
            return null;
        }
    ...
    public VehiclesEntity mapDtoToEntity(Vehicles dto) {
        if (dto == null) {
            return null;
        }
