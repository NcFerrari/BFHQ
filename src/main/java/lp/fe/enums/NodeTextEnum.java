...
public enum NodeTextEnum {
    ...
    CMD_TIME("CMD time", "Doba strávená jako velitel"),
    SQL_TIME("SQL time", "Doba strávená jako velitel týmu"),
    SQM_TIME("SQM time", "Doba strávená jako člen týmu"),
    ...
    KIT_EQUIPMENT("KIT EQUIPMENT", "ZBRANĚ"),
    ...
    BADGE_2_1031105("Veteran Engineer Combat", "Veterán-inženýr"),
    BADGE_2_1031109("Veteran Sniper Combat", "Veterán-odstřelovač"),
    BADGE_2_1031113("Veteran Medic Combat", "Veterán-zdravotník"),
    ...
    BADGE_2_1031619("Veteran Pistol Combat", "Veterán-boj s pistolí"),
    BADGE_2_1031923("Veteran Ground Defense", "Veterán-pozemní obrana"),
    BADGE_2_1032415("Veteran Explosive Ordinance", "Veterán-práce s výbuš."),
    BADGE_2_1190304("Veteran Command", "Veterán-rozkazy"),
    BADGE_2_1190507("Veteran Engineer", "Veterán-inženýr opravář"),
    BADGE_2_1190601("Veteran First Aid", "Veterán-první pomoc"),
    ...
    BADGE_3_1031406("Expert Knife Combat", "Expert-boj s nožem"),
    ...
    RIBBON_3040718("Ground Defense Ribbon", "Stuha za obranu země"),
    RIBBON_3150914("Infantry Officer Ribbon", "Stuha důstojníkovi pěchoty"),
    RIBBON_3151920("Staff Officer Ribbon", "Stuha štábnímu důstojníkovi"),
