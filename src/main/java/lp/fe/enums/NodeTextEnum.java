...
public enum NodeTextEnum {
    ...
    SORT_BY_RANK("Sort by ranks", "Seřadit dle hodností"),
    SORT_BY_KILLS("Sort by kills", "Seřadit dle zabití"),
    SORT_BY_DEATHS("Sort by deaths", "Seřadit dle smrtí"),
    SORT_BY_COUNT_OF_AWARDS("Sort by count of awards", "Seřadit dle počtu ocenění"),
    SORT_BY_TIME("Sort by time", "Seřadit dle herního času"),
    SORT_BY_SCORE("Sort by score", "Seřadit dle skóre"),
    SORT_BY_WINS("Sort by wins", "Seřadit dle výher"),
    SORT_BY_LOSSES("Sort by losses", "Seřadit dle proher"),
